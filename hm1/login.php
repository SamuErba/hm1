<?php
    ...
    if (!empty($_POST["username"]) && !empty($_POST["password"]) )
    {
        ...
        $query = "SELECT id_cliente, username, password FROM cliente WHERE $searchField = '$username'";
        // Esecuzione
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if (password_verify($_POST['password'], $entry['password'])) {
                ...
                $_SESSION["_slpb_username"] = $entry['username'];
                $_SESSION["_slpb_cliente_id"] = $entry['id_cliente'];
                header("Location: home.php");
...
<head>
        ...
        <title>La Palma Blu - Accedi</title>
    </head>
    <body>
        <main class="login">
        ...
        <section class="main_right">
            ...
            <div class="registrazione">Non hai un account? <a href="registrazione.php">Iscriviti</a>
        </section>
        </main>
    </body>
</html>